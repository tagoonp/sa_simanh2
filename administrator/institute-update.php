                    ...
                    <div class="container-fluid p-y-md">
                      <div class="row">
                        <div class="col-sm-12">
                          ...
                          <button type="button" name="button" class="btn btn-app-orange" onclick="changepage('institute-info.php?inst_id=<?php print $_GET['inst_id'];?>')"><i class="fa fa-search"></i> Institute info.</button>
                          <button type="button" name="button" class="btn btn-app-red" onclick="changepage_confirm('institute-delete.php?inst_id=<?php print $_GET['inst_id'];?>')"><i class="fa fa-trash"></i> Delete</button>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-12 col-lg-12">
                          <div class="card">
                              <div class="card-header bg-blue bg-inverse">
                                  <h4>Update hospital / institute information</h4>
                              </div>
                              <div class="card-block">
                                <div class="row">
                                  <div class="col-sm-6">
                                    <form class="js-validation-material form-horizontal m-t-sm" action="controller/institute-update.php" method="post">
                                      <div class="form-group" style="padding-top: 20px;">
                                          <div class="col-xs-12">
                                              <div class="form-material">
                                                  <input class="form-control" type="text" id="txt-instituteid" name="txt-instituteid" readonly value="<?php print $resultInstitute[0]['institute_id'];?>" />
                                                  <label for="register5-firstname">Institute's ID <span style="color:red;">**</span></label>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="form-group" style="padding-top: 20px;">
                                          <div class="col-xs-12">
                                              <div class="form-material">
                                                  <input class="form-control" type="text" id="txt-institutename" name="txt-institutename" placeholder="Enter name of institute or hospital..." value="<?php print $resultInstitute[0]['institute_name'];?>" />
                                      ...
                                      <div class="form-group">
                                        <div class="col-xs-12">
                                          <div class="form-material">
                                              <textarea class="form-control" name="txt-detail" id="txt-detail" rows="4" placeholder="Enter description.."><?php print $resultInstitute[0]['institute_description']; ?></textarea>
                                      ...
                                      <div class="form-group">
                                          <div class="col-xs-12">
                                              <div class="form-material">
                                                  <input class="form-control" type="text" id="txt-phone" name="txt-phone" placeholder="Enter institute or hospital phone number..." value="<?php print $resultInstitute[0]['institute_phone']; ?>" />
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-material">
                                                <select class="form-control" id="txt-type" name="txt-type" size="1">
                                                  ...
                                                  <option value="1" <?php if($resultInstitute[0]['institute_type']=='1'){ print "selected"; } ?>>Monitoring Center</option>
                                                  <option value="2" <?php if($resultInstitute[0]['institute_type']=='2'){ print "selected"; } ?>>Hospital</option>
                                                  <option value="3" <?php if($resultInstitute[0]['institute_type']=='3'){ print "selected"; } ?>>Clinic</option>
                                                </select>
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                          <div class="form-group">
                                              <div class="col-xs-12">
                                                  <div class="form-material">
                                                      <input class="form-control" type="text" id="txt-lat" readonly name="txt-lat" placeholder="Enter institute or hospital phone number..." value="<?php if($resultInstitute[0]['institute_latitute']==''){ print "-25.748688"; }else{ print $resultInstitute[0]['institute_latitute'];}?>" />
                                        ...
                                        <div class="col-sm-6">
                                          <div class="form-group">
                                              <div class="col-xs-12">
                                                  <div class="form-material">
                                                      <input class="form-control" type="text" id="txt-lng" readonly name="txt-lng" placeholder="Enter institute or hospital phone number..." value="<?php if($resultInstitute[0]['institute_longitude']==''){ print "28.223345"; }else{ print $resultInstitute[0]['institute_longitude'];}?>" />
