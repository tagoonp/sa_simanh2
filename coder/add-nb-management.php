...
$resultNB = false;
if(isset($_GET['nbid'])){
  $strSQL = sprintf("SELECT * FROM ".$tbprefix."outcome a left join ".$tbprefix."other_postnatal b on a.nb_no = b.nb_no  WHERE a.nb_no = '%s' and a.record_id = '%s'", mysql_real_escape_string($_GET['nbid']), mysql_real_escape_string($info['record_id']));
  $resultNB = $db->select($strSQL, false, true);

  if(!$resultNB){
    header('Location: add-post-njewborn.php');
    exit();
  }
}
?>
                        ...
                        <div class="col-sm-12">
                          <div class="card">
                            <ul class="nav nav-tabs" data-toggle="tabs">
                                <li class="active">
                                    <a href="#btabs-static-home">Baby information</a>
                                </li>
                                <li >
