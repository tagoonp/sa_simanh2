<?php
$strSQL = sprintf("SELECT count(*) total FROM ".$tbprefix."registerrecord a left join ".$tbprefix."complication_delivery b
          ...
          AND b.pret = '1'", mysql_real_escape_string($valueUserinfo['institute_id']));
