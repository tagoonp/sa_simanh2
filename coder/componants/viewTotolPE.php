<?php
$strSQL = sprintf("SELECT count(*) total FROM ".$tbprefix."registerrecord a inner join ".$tbprefix."postnatal b
          ...
          AND b.pos_com2 = '1'", mysql_real_escape_string($valueUserinfo['institute_id']));
