                              ...
                              <div class="card-block" style="padding-top: 30px;">
                                ...
                                <div class="form-group">
                                  <div class="col-xs-12">
                                    ...
                                    <label class="css-input css-radio css-radio-lg css-radio-danger m-r-sm">
                                      <input type="radio" name="radio-alive" id="radio-alive1" value="0" onclick="toggle_value('txtAlive', 0);"  /><span></span> No
                                    </label>&nbsp;&nbsp;
                                    <label class="css-input css-radio css-radio-lg css-radio-success">
                                      <input type="radio" name="radio-alive" id="radio-alive2" value="1" onclick="toggle_value('txtAlive', 1);" checked /><span></span> Yes
                                    </label>
                                  </div>
                                </div>

                                <div class="aliveCondition1">
                                  <div class="form-group" style="padding-top: 10px;">
                                    <div class="col-xs-12">
                                      <label for="material-text">Stillbirth type <span style="color:red;">**</span></label>&nbsp;&nbsp;&nbsp;<br>
                                      <div class="" checked style="display:none;" >
                                        <label class="css-input css-radio css-radio-lg css-radio-danger m-r-sm">
                                          <input type="radio" name="radio-alivecon" id="radio-alivecon0" value="0" /><span></span>
                                        </label>&nbsp;&nbsp;
                                      </div>

                                      <label class="css-input css-radio css-radio-lg css-radio-success m-r-sm">
                                        <input type="radio" name="radio-alivecon" id="radio-alivecon1" value="1"  /><span></span> Male
                                      </label>&nbsp;&nbsp;
                                      <label class="css-input css-radio css-radio-lg css-radio-success">
                                        <input type="radio" name="radio-alivecon" id="radio-alivecon2" value="2"  /><span></span> Female
                                      </label>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-xs-12">
                                    ...
                                    <label class="css-input css-radio css-radio-lg css-radio-danger m-r-sm">
                                      <input type="radio" name="radio-bdf" id="radio-bdf1" value="0" checked /><span></span> No
                                    </label>&nbsp;&nbsp;
                                    <label class="css-input css-radio css-radio-lg css-radio-success">
                                      <input type="radio" name="radio-bdf" id="radio-bdf2" value="1"  /><span></span> Yes
                                    </label>
                                  </div>
                                </div>

                                <div class="bdfCondition1" style="display:;">
                                  <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="form-material">
