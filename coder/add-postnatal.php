...
$strSQL = sprintf("SELECT * FROM ".$tbprefix."postnatal WHERE record_id = '%s'", mysql_real_escape_string($info['record_id']));
    ...
    <body class="app-ui layout-has-drawer layout-has-fixed-header">
        <div class="app-layout-canvas">
            <div class="app-layout-container">
                ...
                <?php
                if($result){
                  include "page/update-postnatal.php";
                }else{
                  include "page/insert-postnatal.php";
                }
                ?>
